#ifndef TrigPinMicro_h
#define TrigPinMicro_h
...
public:
  TrigPinMicro(uint8_t _pino, unsigned long _highMs, unsigned long _lowMs, uint8_t _disparoContinuo, uint8_t _highLowDefault );
